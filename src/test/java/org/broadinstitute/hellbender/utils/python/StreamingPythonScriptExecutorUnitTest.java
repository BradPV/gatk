...
public class StreamingPythonScriptExecutorUnitTest extends GATKBaseTest {
    ...
    @Test(dataProvider="supportedPythonVersions", dependsOnMethods = "testPythonExists", timeOut=10000)
    ...
    @Test(dataProvider="supportedPythonVersions", dependsOnMethods = "testPythonExists")
    ...
    @Test(dataProvider="supportedPythonVersions", dependsOnMethods = "testPythonExists", expectedExceptions = RuntimeException.class)
    ...
    @Test(dataProvider="supportedPythonVersions", dependsOnMethods = "testPythonExists", expectedExceptions = IllegalArgumentException.class)
    ...
    @Test(dataProvider="supportedPythonVersions", dependsOnMethods = "testPythonExists", timeOut=10000, invocationCount = 20)
    ...
    @Test(dataProvider="supportedPythonVersions", dependsOnMethods = "testPythonExists", timeOut=10000, invocationCount = 10)
    public void testAsyncWriteService(final PythonScriptExecutor.PythonExecutableName executableName) throws IOException, InterruptedException {
        ...
        try {
            ...
            try (final FileOutputStream fileWriter = new FileOutputStream(fifoFile)) {
                ...
                FIFOWriteService = streamingPythonExecutor.getAsynchronousStreamWriterService(fileWriter);
                ...
                for (int i = 0; i < ROUND_TRIP_COUNT; i++) {
                    if (i != 0 && (i % syncFrequency) == 0) {
                        ...
                        FIFOWriteService.startAsynchronousBatchWrite(fifoData, count);
                        count = 0;
    ...
    @Test(dataProvider="supportedPythonVersions", dependsOnMethods = "testPythonExists", expectedExceptions = PythonScriptExecutorException.class)
