...
public class StreamingPythonScriptExecutor extends PythonExecutorBase {
     ...
     */
    public <T> AsynchronousStreamWriterService<T> getAsynchronousStreamWriterService(final OutputStream streamWriter) {
        Utils.nonNull(streamWriter);
        return spController.getAsynchronousStreamWriterService(streamWriter);
    }
