...
public final class StreamingProcessController extends ProcessControllerBase<CapturedStreamOutputSnapshot> {
     ...
     */
    public <T> AsynchronousStreamWriterService<T> getAsynchronousStreamWriterService(final OutputStream outputStream) {
        Utils.nonNull(outputStream);
        return new AsynchronousStreamWriterService<>(executorService, outputStream);
    }
