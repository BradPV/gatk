 ...
 * <li>Creates an AsyncWriterervice</li>
 * <li>Writes a string of attributes for each read to the List until the batchSize theshold is reavched.</li>
...
public class ExampleStreamingPythonExecutor extends ReadWalker {
    ...
    public void onTraversalStart() {
        ...
        try {
            ...
            asyncWriter = pythonExecutor.getAsynchronousStreamWriterService(fifoWriter);
        } catch ( IOException e ) {
    ...
    private void startAsynchronousBatchWrite() {
        ...
        asyncWriter.startAsynchronousBatchWrite(batchList, batchCount);
    ...
    public void closeTool() {
        ...
        try {
            ...
            throw new GATKException("IOException closeing fifo writer", e);
        }
